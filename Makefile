...
CFLAGS = -Iinclude $(addprefix -I, $(wildcard libraries/*/include)) -ffreestanding -Os --specs=nano.specs -ffunction-sections -fdata-sections -Wl,--gc-sections -DMY_RISCV -Wstack-usage=1000
